...
Comprehensive documentation for Charmed Authentik and the LDAP Outpost is available on the [Canonical Identity Platform Documentation](https://canonical-identity.readthedocs-hosted.com/):
...
- **How-To Guides**: [Protect LDAP Applications with Charmed Authentik](https://canonical-identity.readthedocs-hosted.com/how-to/authentik/protect-ldap-applications/)
- **Reference**: [Charmed Authentik LDAP Outpost Reference](https://canonical-identity.readthedocs-hosted.com/reference/authentik/charms/authentik-ldap-outpost/)
- **Explanation**: [Charmed Authentik Security Architecture](https://canonical-identity.readthedocs-hosted.com/explanation/authentik/security/)
---
